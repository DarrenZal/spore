...
7. **Canon rebuild Phase 2b-2c + Phase 3 + Phase 4 pending** — Phase 2b: mycorrhizal federation → federation protocol rename (C-20). Phase 3: Core Thesis rewrite (C-01 + C-02 + C-03) — parallel-authorable, largest single ADR, 7-day cooling-off. Phase 2c: after Phase 3, splits into 3a/3b/3c (fractal delete / intent-pressure delete / dynamical-vocabulary audit). Phase 4: 9 new foundation docs (sensor/oracle, translation, actor governance, representation authority, actuator, failure-modes, min-viable-Spore, external-validation, maintenance-economics); priority: sensor/oracle first, translation second, representation-authority third (tightly coupled to ADR-0041). Phase 5: section-level status labels, last.
