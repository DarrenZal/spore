...
**What's Left:**
1. **Canon-review Round 1 complete (2026-04-22)** — ADR-0029 (governance-memory framing cleanup) + ADR-0030 (adoption-section restructure) landed on main via canon-review-protocol v3 with operator-authorized adversarial-critique adaptation. Concepts-p2p-wiki bumped v2→v3 (+2 slugs: `governance-memory`, `adoption-surface`). Validator held at 9/30 baseline throughout. Plan: `~/.claude/plans/canon-review-r1-adoption-governance-memory.md` (CLOSED). Commits: `3a09d61` (vocab v3), `89bb982`/`3cf4357` (ADR-0029), `e3ba665`/`b24b7c0` (ADR-0030). Session-atomic window: 119s. Addresses CC-01 + CC-04 + CC-05 from adversarial critique.
2. **Canon-review Round 2 pending** — universality-language cleanup (CC-02 + CC-08 + CC-09), bundled across `project-vision.md` + `constitutional-artifacts-and-graph-projections.md` + `holonic-network-architecture.md`. Author as separate plan when ready. Adversarial critique findings persist at `/Users/darrenzal/projects/spore/tmp/canon-adversarial-critique-2026-04-21.md` (14 consolidated findings, 10 remaining to route through Rounds 2-4).
