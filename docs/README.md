...
Spore is a coordination grammar for collective agency across plural, sovereign systems — for local-to-global coherence at the scales it has reached. It develops and publishes **Agent Commons**: a pattern language, protocol family, and governance-memory pattern that enables coordination and coherence without surrendering sovereignty.
...
- [maintenance-economics.md](./foundations/maintenance-economics.md) — 8-category maintenance-economics doctrine (reproductive-labor visibility / maintainer-economics / foundation-vs-pattern boundary / translation-labor / infrastructure-economics / substitution-trap-economics / labor-class standing-to-contest / cross-federation portability) under B5 SELECTIVE per-category synthesis-depth (2 HEAVY + 6 SELECTIVE); H3 4-way hybrid substrate-parents structural-legitimacy + reproductive-commoning + reproduction-continuity AND operational-pair sibling to sensor-oracle-governance + actor-governance; discharges F1 §4.3 + F3 §4.6 sub-shape 4 forward-refs; foundation-vs-pattern boundary as load-bearing canon-discipline
- [spore-instance-model.md](./foundations/spore-instance-model.md) — how Spore materializes: canon, node, agent, site
- [external-validation-loop.md](./foundations/external-validation-loop.md) — 5-category external-validation-loop doctrine (external-witness reading-of-canon as authoritative-input / routing through governance-bodies / revision-trigger discipline / comparative-intake-protocol as canonical pipeline / cross-modality witness inheritance) under B5 SELECTIVE per-category synthesis-depth (1 HEAVY + 4 SELECTIVE); H3 4-way hybrid substrate-parents structural-legitimacy + representation-authority + actor-governance AND operational-pair sibling to sensor-oracle-governance; discharges 5+ forward-refs (F4 §43+§115+§184 §iii + F3 via ADR-0077 §222 + F7 ADR-0078 §181 + F9 ADR-0079 §221) — HIGHEST single-ADR forward-ref discharge in canon-rebuild arc; canon-authorship-vs-canon-readership asymmetry preservation as load-bearing doctrine; F4-anticipated admission completing F4 §184 §iii revision-trigger loop
...
- [bkc-seven-layer-stack-as-instance-instantiation.md](./research/connections/bkc-seven-layer-stack-as-instance-instantiation.md) — BKC's seven-layer operational stack mapped to Spore primitives, patterns, and foundation docs with explicit lossiness boundaries
...
- [canon-coverage-gaps.md](./positioning/canon-coverage-gaps.md) — honest positioning note naming what current canon does not yet cover and where pattern/protocol/instance layers take over
