...
**Power across primitives** (ADR-0047). Spore does not admit Power/Authority as a distinct primitive. Power operates in four distinct structural modes across the corpus — enumerated-powers-by-role (Governance-Process), asymmetric-vulnerability (Care/Feminist Economics), power-capture as compound-failure (Commons-commoning school), relational-spiritual authority (Pluriversal) — and no single primitive could capture all four without either breaking parsimony or collapsing structurally distinct modes. Canon decomposes Power across three existing-primitive asymmetry axes: (1) **authority-over-rule-levels** on Field-rule-stratification (capacity to set/amend/enforce rules at operational / collective-choice / constitutional levels); (2) **asymmetric-commitment** on Commitment-party-structure (disproportionate binding; asymmetric-vulnerability); (3) **asymmetric-membrane** on Membrane-authorize (asymmetric gatekeeping; admission/exclusion authority). ADR-0005's decentralization-myth-bundle names the compound power-capture failure mode at critique-frame level; ADR-0047's three asymmetry axes name the structural substrate that compound-capture operates through. Together, canon expresses both the critique-frame and the mechanism. Relational-spiritual authority (Borrows' five-sources-of-law) is held under ADR-0001 pluriversal-incommensurability at Layer-1's Western-legal-frame adjacency; Layers 2 and 3 accommodate sacred-commitment and ritual-authorization at mechanism-level without collapsing ontological plurality.
