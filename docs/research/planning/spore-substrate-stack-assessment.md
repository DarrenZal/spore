...
- [governance-artifacts-and-graph-projections.md](../../foundations/governance-artifacts-and-graph-projections.md) already treats text and graph as complementary views rather than a graph-only system.
