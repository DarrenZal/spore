...
r_claim_source:
  ...
  - ic.connection.peer-governance-wikipedia-opposition:R4
  - ic.connection.digital-labor-peer-production-opposition:R4
...
- **Bridge notes (Spore direct)**: `spore.connection.decentralization-theater-opposition` (primary R1, secondary R-claims R2–R5 — R2 out of canon, R3–R5 cross-project context), `ic.connection.peer-governance-wikipedia-opposition` (R4 cross-composition with dt R1; R1–R3 are IC-targeting), `ic.connection.digital-labor-peer-production-opposition` (R4 connection-note context; R1–R6 mostly IC/PM-targeting).
