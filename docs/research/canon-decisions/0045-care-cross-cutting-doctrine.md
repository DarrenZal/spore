...
### Sahely-Maturana school as substrate-evidence enrichment (per ADR-0088 scope-condition substrate-strengthening, 2026-05-25)

The Sahely corpus Phase 2 (closure 2026-05-22) surfaced an additional FULL tradition-cluster that this ADR's original §Operational-earning + §Evidence did not cite at substrate layer: **Sahely-Maturana school articulating care-as-structural-coupling**. Per `spore:ADR-0088-care-cluster-scope-condition-adr-0045` (the canon-decision-record companion to this narrative-extension), the Maturana-school lineage — Maturana / Verden-Zöller / Bunnell / Dávila Yáñez — provides a foundational-relational reading of care that complements (does NOT replace) the asymmetric-relational reading via Held / Tronto / Kittay / Federici this ADR's §Operational-earning already establishes.

The substrate-evidence enrichment articulates care-as-structural-coupling at two registers:

- **Foundational-relational register** (Sahely W1.1 *Toward a Maturana-Informed Viability Grammar* 2026-05-21 at `spore.connection.sahely-maturana-viability-grammar`): Maturana's biology of love as "the relational domain in which the other arises as legitimate in coexistence, is not sentimental but foundational" (C-6 LOAD-BEARING claim, pdf-p3 verbatim). The Sahely paper's central diagrammatic figure presents 8 viability-grammar primitives circled around a single central LOVE-as-relational-ground node — structurally distinct from primitives-as-reflective-questions; read in Spore terms, sits in the same canon-shape slot as care-commoning doctrine (cross-cutting, operating beneath/across primitives rather than as a primitive among them).
- **Clinical-operational register** (Sahely W1.2 *Biology of Living Coordination* 2026-05-22 at `spore.connection.sahely-biology-of-living-coordination`): "Health is reframed as coherent transition; disease as discoordination, narrowing, or locked transition; healing as restored movement; **care as structural coupling**; public health as protection of living conditions; and civilization as an extended niche that may become salugenic or pathogenic" (C-7 verbatim, pdf-p3). The clinical operationalization positions care AS the practice through which structural coupling is sustained — the same operational concern this ADR's §Context articulates as care-as-asymmetric-relational-practice, approached from the Maturanan organism-medium congruence angle.

W3.3 + W4.3 substrate-strengthening at clinical-encounter scale (per Sahely DECISION-BRIEF §17.4): `spore.connection.sahely-systems-immunology` (W3.3) operationalizes clinical-encounter-as-structural-coupling at immunology scale; `spore.connection.sahely-medicine-of-living-coherence` (W4.3) operationalizes care-as-structural-coupling at medicine scale. Both deepen Cluster 2's substrate-evidence base beyond W1.1/W1.2 origin.

**Cluster-counting honest math** (per Sahely DECISION-BRIEF §5.2 + ADR-0064 honest-rigor + `feedback_surface_vocabulary_vs_operational_concern.md`):

- **Cluster 1 (existing, preserved)**: Held three-sense / Tronto four-phase / Kittay nested-dependency / Federici invisibilisation — FULL, canonically established at this ADR's §Operational-earning.
- **Cluster 2 (new, admitted via ADR-0088 scope-condition)**: Maturana / Verden-Zöller / Bunnell / Dávila Yáñez — FULL, verified at Sahely W1.1 + W1.2 + W3.3 + W4.3 substrate.

Both clusters meet the ≥2-cluster threshold for scope-condition substrate-strengthening (NOT the ≥3-cluster threshold for new admission). Adjacent partial clusters (Hochschild emotional labor / Folbre care economics / Whyte-Kimmerer Indigenous kinship-care / Noddings caring relations) are noted as substrate-resonance but NOT counted as a third FULL cluster — overlaps with existing Cluster 1 lineage, not independent traditions.

**Doctrine territory unchanged**: this scope-condition substrate-strengthening does NOT change care-commoning's canonical territory (care as asymmetric-relational practice operating across primitives via doctrine-lens treatment; not paraphrase-able into Spore's symmetric primitive grammar). What it changes is the substrate-evidence base this ADR cites — Maturana's structural-coupling formalism is a foundational-relational reading that complements (NOT replaces) the asymmetric-relational reading via Held/Tronto/Kittay/Federici. Both clusters articulate care-as-foundational-relational-practice through which structural-coupling is sustained, from different tradition-angles. 4-doctrine inventory (reproductive-commoning / boundary-commoning / care-commoning / life-value-doctrine per ADR-0086) preserved unchanged.

**Extend-via-prose precedent**: this narrative-extension follows the discipline established at ADR-0050 §Consequences (joint-commitment + Holon-irreducibility extension), ADR-0077 §Consequences (F3 actor-governance + multi-forward-ref discharge), ADR-0084 §Consequences (Ruddick scope-conditioning), and ADR-0086 §Consequences narrative-ext to ADR-0042 (immanent-ethics fold-in per ADR-0086 §139 diff summary). ADR-0088 §Consequences "Extend-via-prose precedent chain" subsection cites the lineage. The frontmatter of this ADR is preserved byte-equal per Gate (j) discipline (lines 1-38; md5 `7a9a05d3065bdb285492242242edb3cf` captured at ADR-0088 Step 0.5 audit manifest; re-verified at ADR-0088 Step 5).

**Forward-reference**: reader-traceability flows ADR-0088 → ADR-0045 (forward only); this ADR's `related_adrs:` is NOT modified per byte-equal discipline. Future scope-condition revisions can elevate adjacent partial clusters (Hochschild / Folbre / Whyte-Kimmerer / Noddings) if operational pressure surfaces — re-opening triggers documented at ADR-0088 §Downstream.
