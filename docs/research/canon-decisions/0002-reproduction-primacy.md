...
- Opposing bridge notes (primary cluster): 12 oppositional source-claims, primarily from the Wave 1/2/3 opposition notes (FairCoin, decentralisation-theater, digital-labor, peer-governance-wikipedia, openwashing, cooperative-degeneration, market-dependence-theory-opposition). The oppositional evidence is exactly what the canon edit acknowledges: naming reproductive-labour invisibilisation alongside protocol-lock-in, gatekeeper-roles, and data-asymmetry is responsive to the opposition, not against it. The opposition notes identify failure modes; the canon edit declines them explicitly.
